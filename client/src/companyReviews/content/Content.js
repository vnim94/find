        ...
        <div className="bg-white content">
            <div className="page flex flex-col">
                ...
                <div className="flex flex-row flex-jc-c">
                    <Card img="/hand.png" heading="Latest reviews" text="Get the low-down on companies with 1,000 new reviews daily" />
                    <Card img="/rating.png" heading="Comprehensive ratings" text="Companies get rated thoroughly from every angle imaginable" />
                    <Card img="/person_outline.png" heading="By real employees" text="Read about companies through their employees' words" />
                </div>
            </div>
        </div>
    )
